...
static const char *colors[][3]      = {
  ...
  [SchemeTitle]  = { col_gray4, col_gray4 },
};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run","-l", "6", "-g","1","-h", "32" "-fn", dmenufont, "-shb", "#d65d0e", "-shf","#585b70", "-nhb", "#1e1e2e", "-nhf","#585b70" ,NULL }; 
